...
| ------------- | ------------------------- | ------------------------------ | -------------------- | ------------------------------------------------------------------------------------------------------------- |
| Unit Tests    | Colocated with source     | __tests__ or .test files       | .test.js/.test.jsx   | Test individual functions, hooks, utilities. Mock external dependencies                                       |
| Component Tests | Component directories   | __tests__ subdirectories       | .test.jsx            | Test rendering, props, user interactions, accessibility with React Testing Library                           |
...
**Examples**: Source: src/components/QuestionTimer.jsx → Test: src/components/__tests__/QuestionTimer.test.jsx | Source: src/context/PointsContext.js → Test: src/context/__tests__/PointsContext.test.js
