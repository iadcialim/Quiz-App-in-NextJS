...
1. **Implementation Scope Selection**: Ask the user to choose their preferred implementation approach:
   ...
   If user doesn't specify, default to "All tasks" approach.
...
5. Execute implementation following the task plan and user's selected approach:
...
9. **Git Commit Message Generation**: After successful implementation completion:
   - Automatically generate a concise git commit message
   - Use conventional commit format (feat:, fix:, docs:, etc.)
   - Summarize the key changes made during implementation
   - Present the message to the user for their commit
